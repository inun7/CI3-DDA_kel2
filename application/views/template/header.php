...
<head>
  ...
  <title>DDA | <?= $titleTag ?></title>
  <!-- Favicon -->
  <link href="<?= base_url('assets/img/brand/Naura.PNG') ?>" rel="icon" type="image/png">
  <!-- Fonts -->
...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-dark bg-default" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand logo_h" href="index.html"><label>DDA A KELOMPOK 2</label></a>
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <i class="ni ni-bullet-list-67 text-orange"></i> Data Akun
            </a>
          </li>
          <li class="nav-item">
